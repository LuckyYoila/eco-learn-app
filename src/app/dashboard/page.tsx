...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row w-[100%] lg:space-x-4 justify-between">
        <div className="md:w-[65%] flex flex-wrap lg:flex-nowrap lg:space-x-4 justify-between mb-4">
          <div className="m-auto sm:mx-0 mb-4 md:my-0 w-[80%] sm:w-[48%] md:w-[33%] h-fit border border-gray-200 bg-white rounded-lg p-3 space-y-2">
      ...
      <div className="flex flex-col sm:flex-row w-[100%] justify-between lg:space-x-4">
        <div className="md:w-[65%] border border-gray-200 bg-white rounded-lg p-3"></div>
        <div className="md:w-[35%] border border-gray-200 bg-white rounded-lg">
          ...
          <div className="p-2 pt-5 flex justify-center space-x-4">
      ...
      <div className="flex flex-col sm:flex-row w-[100%] justify-between lg:space-x-4">
        <div className="md:w-[65%] border border-gray-200 bg-white rounded-lg p-4 space-y-3">
          <div className="flex justify-between">
      ...
      <div className="flex flex-col sm:flex-row w-[100%] justify-between lg:space-x-4">
        <div className="md:w-[65%] border border-gray-200 bg-white rounded-lg p-4 space-y-3">
          ...
          <div className="w-[100%] lg:w-[70%] m-auto flex items-end justify-evenly">
            ...
            <div className="rounded-full w-[71px] h-[71px] bg-purple-800 flex items-center">
              <Avatar className="w-[67px] h-[67px] m-auto">
            ...
            <div className="relative">
            <div className="rounded-full w-[84px] h-[84px] bg-green-700 flex items-center">
              <Avatar className="w-[80px] h-[80px] m-auto">
                <AvatarImage src="https://github.com/shadcn.png" />
                <AvatarFallback>CN</AvatarFallback>
              </Avatar>
            </div>
            <div className="absolute -bottom-2 right-7 rounded-full bg-green-700 size-6 flex justify-center items-center">
              <h1 className="m-auto text-sm text-white">1</h1>
            </div>
            </div>
            <div className="relative">
            <div className="rounded-full w-[71px] h-[71px] bg-orange-500 flex items-center">
              <Avatar className="w-[67px] h-[67px] m-auto">
                <AvatarImage src="https://github.com/shadcn.png" />
                <AvatarFallback>CN</AvatarFallback>
              </Avatar>
            </div>
            <div className="absolute -bottom-2 right-6 rounded-full bg-orange-500 size-6 flex justify-center items-center">
